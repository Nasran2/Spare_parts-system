        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow p-5 border-t-4 border-blue-600">
                ...
                <form method="POST" action="{{ route('accounting.petty-cash.store') }}" class="flex flex-col gap-4">
                    @csrf
                    <div>
                        <label class="block text-xs font-medium text-gray-500 mb-1">Fund Date</label>
                        <input type="date" name="name" value="{{ date('Y-m-d') }}" class="w-full border rounded-lg px-3 py-2 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none transition" required>
                    </div>
                    <div>
