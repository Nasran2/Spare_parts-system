        ...
        <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="tin" value="{{ old('tin', $supplier->tin) }}" inputmode="numeric" pattern="[0-9]{9,12}" maxlength="12" class="w-full mt-1 border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 @error('tin') border-red-500 @enderror">
