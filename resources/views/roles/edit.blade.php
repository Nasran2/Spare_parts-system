    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white">
            <h2 class="text-2xl font-bold flex items-center">
                <i class="fas fa-shield-alt mr-3"></i>Edit Role: {{ $role->name }}
            </h2>
            <p class="text-blue-100 mt-1">Update role information and permissions</p>
        </div>
        ...
        <form action="{{ route('roles.update', $role->id) }}" method="POST" class="p-6 md:p-8 space-y-6">
            ...
            <div class="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
                <p class="text-sm text-yellow-800 flex items-center">
                    ...
                    This role is currently assigned to <strong class="mx-1">{{ $role->users_count }}</strong> user(s). Changes will affect all assigned users.
                </p>
            </div>
            @endif
